...
const RoomType = { STORAGE: 'STORAGE', SERVER_ROOM: 'SERVER_ROOM', MEETING_ROOM: 'MEETING_ROOM', OFFICE: 'OFFICE', PANTRY: 'PANTRY', OTHER: 'OTHER', TOILET: 'TOILET', RECEPTION: 'RECEPTION', BOARDROOM: 'BOARDROOM', OPEN_WORKSPACE: 'OPEN_WORKSPACE' };
const NodeType = { ROOM_ENTRY: 'ROOM_ENTRY', CORRIDOR_JUNCTION: 'CORRIDOR_JUNCTION', WAYPOINT: 'WAYPOINT' };
const EdgeType = { CORRIDOR: 'CORRIDOR', STAIRCASE: 'STAIRCASE', LIFT: 'LIFT' };
