...
export function createPantry(polygon, cx, cz, wM, hM, isCafeteria, isDest, isUser, resources, toWorld, grid, isFloor6Or7 = false) {
  ...
  if ((isCafeteria || isFloor6Or7) && polygon && grid && toWorld) {
